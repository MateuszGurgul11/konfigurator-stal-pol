    ...
    <div className="flex min-h-[80vh] items-center justify-center py-8">
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-[#e30311]">
            <svg
              width="28"
              height="28"
              viewBox="0 0 22 22"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                required
                className="border-[#e5e7eb] focus-visible:ring-[#e30311]"
              />
            </div>
            <div className="space-y-1.5">
              <Label
            ...
            {error && (
              <p className="rounded-md bg-[#fde8ea] px-3 py-2 text-sm text-[#dc2626]">
                {error}
              </p>
            )}
            <Button
              type="submit"
              className="w-full bg-[#e30311] hover:bg-[#c9020f] text-white font-semibold"
              disabled={loading}
            >
        ...
        <p className="mt-4 text-center text-sm text-[#9ca3af]">
          <Link
            href="/"
            className="font-medium text-[#6b7280] transition-colors hover:text-[#e30311]"
          >
