  ...
  return (
    <nav className="border-b border-[#e5e7eb] bg-white">
      <div className="mx-auto flex max-w-6xl flex-wrap items-center gap-1 px-4 py-2.5 sm:px-6">
        <Link
          href="/"
          className="font-heading mr-3 flex items-center gap-1.5 text-[11px] font-semibold uppercase tracking-[0.15em] text-[#9ca3af] transition-colors hover:text-[#e30311]"
        >
