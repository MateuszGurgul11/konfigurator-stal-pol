      ...
      <div className="grid grid-cols-2 gap-2.5">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                selected
                  ? "border-[#e30311] ring-2 ring-[#e30311]/35 ring-offset-2 ring-offset-[#1A1A18]"
        ...
        {backgroundImageUrl && (
          <button
            ...
            className="group relative aspect-[4/3] overflow-hidden rounded-lg border-2 border-[#e30311] ring-2 ring-[#e30311]/35 ring-offset-2 ring-offset-[#1A1A18]"
          >
