...
function RotateHintOrbit() {
  return (
    <svg
      className="pointer-events-none absolute inset-0 h-full w-full text-[#e30311]"
      viewBox="0 0 128 128"
      fill="none"
      aria-hidden
    >
...
function RotateHintScene() {
  return (
    <div className="rotate-hint-scene relative flex items-center justify-center rounded-2xl border border-white/5 px-8 py-6">
      <div
        className="pointer-events-none absolute left-1/2 top-1/2 h-36 w-36 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#e30311]/8 blur-2xl"
        aria-hidden
      />

      <div className="rotate-hint-unit relative flex h-[7.5rem] w-[7.5rem] items-center justify-center">
        <RotateHintOrbit />
        <div className="relative z-10 h-[4.5rem] w-[2.25rem] rounded-[0.7rem] border-[3px] border-white/90 bg-[#2A2A26] shadow-[0_8px_32px_rgba(0,0,0,0.45)]">
          <div className="absolute left-1/2 top-1.5 h-1 w-6 -translate-x-1/2 rounded-full bg-white/30" />
          <div className="absolute inset-x-1.5 top-4 bottom-4 overflow-hidden rounded-[0.2rem] bg-gradient-to-b from-[#2a0e10] to-[#1A1A18]" />
